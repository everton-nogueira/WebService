...
public class WebServiceImplServiceLocator extends org.apache.axis.client.Service implements br.com.everton.wsdl.WebServiceImplService {
    ...
    private java.lang.String WebServiceImplPort_address = "http://localhost:8080/TreinamentoWebService/WebServiceImpl";
    ...
    public br.com.everton.wsdl.MeuWebservice getWebServiceImplPort() throws javax.xml.rpc.ServiceException {
    ...
    public br.com.everton.wsdl.MeuWebservice getWebServiceImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.com.everton.wsdl.WebServiceImplServiceSoapBindingStub _stub = new br.com.everton.wsdl.WebServiceImplServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.com.everton.wsdl.MeuWebservice.class.isAssignableFrom(serviceEndpointInterface)) {
                br.com.everton.wsdl.WebServiceImplServiceSoapBindingStub _stub = new br.com.everton.wsdl.WebServiceImplServiceSoapBindingStub(new java.net.URL(WebServiceImplPort_address), this);
                _stub.setPortName(getWebServiceImplPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://everton.com.br/", "WebServiceImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://everton.com.br/", "WebServiceImplPort"));
        }
